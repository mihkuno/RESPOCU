...
const researchTypes = [
  ...
  export default function Publications(
      ...
      const handleConfirmSubmit = async () => {
        ...
        formData.append('advisor', study.advisor);
        ...
        // Add the study to the published studies if not already added
        setPublishedStudies(prev => {
      ...
      const validateFile = (file: File): boolean => {
          ...
          if (file.size > MAX_FILE_SIZE) {
              setFileError(`File size exceeds 1MB limit. "${file.name}" is ${formatFileSize(file.size)}.`);
              return false;
          }
          ...
          <>
              ...
              <form onSubmit={handleSubmitAttempt} className="bg-white rounded-lg shadow-lg p-8 border border-gray-100">
                  ...
                  <div className="space-y-8">
                      ...
                      {/* Advisor */}
                      <div>
                          <label htmlFor="advisor" className="block text-sm font-medium text-gray-700 mb-2 uppercase tracking-wide">
                          ...
                          <input
                              ...
                              onChange={handleInputChange}
                              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#292F36] focus:border-transparent transition-all duration-200"
                              placeholder="Add research advisor name"
                          />
                      </div>
