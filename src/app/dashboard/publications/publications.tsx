...
// Modal types
type ModalType = 'validation' | 'confirmation' | 'success' | 'error';
...
// Modal Component
const Modal = ({ isOpen, type, title, message, onConfirm, onCancel }: ModalProps) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4 bg-black/10">
      <div className={`${getBgColor()} p-6 rounded-lg shadow-xl max-w-md w-full transform transition-all`}>
        ...
        <div className="flex justify-end space-x-3">
          ...
          <button
            className={`px-4 py-2 ${getButtonColor()} text-white rounded transition-colors`}
            onClick={onConfirm}
          >
