...
export default function OTPVerification({ initialState = 'default' }) {
    ...
    useEffect(() => {
        if (verificationState === 'loading') {
            const timer = setTimeout(() => {
                // Simulate API response - change to 'verified' or 'invalid' based on your needs
                const mockResult = new URLSearchParams(window.location.search).get('mock') || 'verified';
                setVerificationState(mockResult);
            }, 2000);
                ...
                return (
                    <>
                        ...
                        <div className="mt-6 text-center">
                            <Link href="/login" className="inline-flex items-center text-sm text-gray-600 hover:text-red-900 transition-colors">
                ...
                return (
                    <>
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-700 font-medium">user@email.com</p>
                        </div>
